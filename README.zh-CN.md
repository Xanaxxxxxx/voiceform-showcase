...
这个仓库是 Voiceform 的公开展示层，重点放在产品方向、架构边界与设计语言。
...
[查看贡献记录](https://github.com/Xanaxxxxxx/Voiceform/graphs/contributors)
...
| 隐私政策 | [Voiceform Privacy Policy](privacy.md) |
| 支持 | [Voiceform Support](support.md) |
| 主仓库 | [Voiceform main repository](https://github.com/Xanaxxxxxx/Voiceform) |
