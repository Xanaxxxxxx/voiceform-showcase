...
這個倉庫是 Voiceform 的公開展示層，重點放在產品方向、架構邊界與設計語言。
...
[查看貢獻紀錄](https://github.com/Xanaxxxxxx/Voiceform/graphs/contributors)
...
| 隱私政策 | [Voiceform Privacy Policy](privacy.md) |
| 支援 | [Voiceform Support](support.md) |
| 主倉庫 | [Voiceform main repository](https://github.com/Xanaxxxxxx/Voiceform) |
